...
public class AutoGenerator {
	 ...
	 */
	private static final double FIRST_PULL = 102 - 18;
	/**
	 ...
	 */
	private static final double SECOND_PULL = 35 + 18;
	...
	public static ArrayList<Command> gearPassiveRight() {
		ArrayList<Command> list = new ArrayList<>();
		list.add(new PIDFullDrive(FIRST_PULL - 8));
